...
public:
    ...
    */
    // En AC_AttitudeControl_Multi_6DoF.h dentro de la clase AC_AttitudeControl_Multi_6DoF
    void thrust_vector_rotation_angles(const Quaternion& attitude_target, const Quaternion& attitude_body, Quaternion& thrust_vector_correction, Vector3f& attitude_error, float& thrust_angle, float& thrust_error_angle) const override;
    ...
    float get_althold_lean_angle_max_cd() const override { return 8000.0f; }
